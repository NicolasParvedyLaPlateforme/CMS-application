...
export default function LessonsPage() {
  const { course, addLesson, deleteLesson } = useCourse();
      ...
      {course.lessons.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredLessons.map((lesson) => (
            <div key={lesson.id} className="bg-white border border-slate-200 rounded-lg p-4 shadow-sm flex gap-4 flex-col sm:flex-row sm:items-center justify-between">
